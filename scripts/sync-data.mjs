...
const PER_LOCALE = [
  ...
  "map-simulator/data/interactive_placing_{loc}/expl_chest.json",
  "map-simulator/data/interactive_placing_{loc}/guard_chest.json",
  "map-simulator/data/interactive_placing_{loc}/monster_chest.json",
  "map-simulator/data/interactive_placing_{loc}/mystery_chest.json",
  "map-simulator/data/interactive_placing_{loc}/landmark_photography.json",
  "map-simulator/data/interactive_placing_{loc}/kafra_service.json",
  "map-simulator/data/interactive_placing_{loc}/cooking_recipes.json",
  "map-simulator/data/interactive_placing_{loc}/jd.json",
  "map-simulator/data/interactive_placing_{loc}/private_chef.json",
  "map-simulator/data/interactive_placing_{loc}/quest_mark_008.json",
  "map-simulator/data/interactive_placing_{loc}/rw_quest.json",
