...
const styles = StyleSheet.create({
  ...
  filterToggleText: { color: "#41506B", fontSize: 14, fontWeight: "bold" },
  filterToggleIcon: { color: "#8A97AD", fontSize: 12, fontWeight: "bold" },
  ...
  subChip: { backgroundColor: "#F1F6FC" },
  fChip: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 999, margin: 4,
    borderWidth: 1, borderColor: "#C9D6EE", backgroundColor: "#FFFFFF" },
  fChipOn: { backgroundColor: "#6E83E8", borderColor: "#6E83E8" },
  ...
  sectionCount: { color: "#8A97AD", fontSize: 12, fontWeight: "bold" },
  row: { flexDirection: "row", backgroundColor: "#FFFFFF", borderRadius: 12, padding: 12,
    marginHorizontal: 14, marginVertical: 6, borderWidth: 1, borderColor: "#DCE6F4" },
  iconWrap: { width: 56, height: 56, borderRadius: 8, backgroundColor: "#EAF1FB",
    alignItems: "center", justifyContent: "center", marginRight: 12 },
  icon: { width: 48, height: 48 },
  iconFallback: { backgroundColor: "#E3EAF5", borderRadius: 6 },
  body: { flex: 1 },
  titleRow: { flexDirection: "row", alignItems: "center", marginBottom: 2 },
  name: { color: "#41506B", fontSize: 15, fontWeight: "bold", flex: 1, marginRight: 8 },
  badge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 999 },
  badgeText: { color: "#FFFFFF", fontSize: 10, fontWeight: "bold" },
  effect: { color: "#5A6781", fontSize: 13, lineHeight: 18 },
  ...
  modalIconWrap: { width: 72, height: 72, borderRadius: 10, backgroundColor: "#EAF1FB",
    alignItems: "center", justifyContent: "center", marginRight: 14 },
  modalIcon: { width: 60, height: 60 },
  modalTitle: { color: "#41506B", fontSize: 18, fontWeight: "bold", flexShrink: 1 },
  modalSub: { color: "#8A97AD", fontSize: 13, marginTop: 2 },
  modalEffect: { color: "#5A6781", fontSize: 14, lineHeight: 20, marginBottom: 4 },
  // equipment facts block (type / jobs / level …) shown above the stat table
  metaBox: { backgroundColor: "#F1F6FC", borderRadius: 10, paddingHorizontal: 12,
    paddingVertical: 4, marginBottom: 10 },
  metaRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start",
    paddingVertical: 6 },
  metaLabel: { color: "#8A97AD", fontSize: 13, marginRight: 12 },
  metaValue: { color: "#5566C7", fontSize: 13, fontWeight: "bold", flexShrink: 1, textAlign: "right" },
  refineHead: { color: "#8A97AD", fontSize: 12, fontWeight: "bold", marginTop: 10, marginBottom: 2 },
  detailTable: { marginTop: 12, borderTopWidth: 1, borderTopColor: "#DCE6F4" },
