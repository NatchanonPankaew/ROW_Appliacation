...
const styles = StyleSheet.create({
  ...
  markerHalo: { width: 40, height: 40, borderRadius: 999, backgroundColor: "rgba(255,255,255,0.85)",
  ...
  markerEmoji: { fontSize: 22, lineHeight: 26 },
  markerDone: { opacity: 0.4 },
  markerDoneBadge: { position: "absolute", top: -5, right: -5, width: 20, height: 20, borderRadius: 999,
    backgroundColor: "#3FA35A", alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: "#FFFFFF" },
  markerDoneBadgeText: { color: "#FFFFFF", fontSize: 12, fontWeight: "bold", lineHeight: 14 },
