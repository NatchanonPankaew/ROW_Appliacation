...
const styles = StyleSheet.create({
  ...
  marker: { position: "absolute", width: 48, height: 48, marginLeft: -24, marginTop: -24 },
  markerHalo: { width: 48, height: 48, borderRadius: 999, backgroundColor: "rgba(255,255,255,0.95)",
