...
const styles = StyleSheet.create({
  ...
  marker: { position: "absolute", width: 36, height: 36, marginLeft: -18, marginTop: -18 },
  markerHalo: { width: 36, height: 36, borderRadius: 999, backgroundColor: "rgba(255,255,255,0.95)",
  ...
  markerDoneBadgeText: { color: "#FFFFFF", fontSize: 9, fontWeight: "bold", lineHeight: 11 },
